...
verifyArguments <- function(cpmType, ARL0, startup, lambda) {
  ...
  else if (cpmType == "Lepage") {
    cpmType <- "LP"
  }
  else if (cpmType == "Mann-Whitney") {
    cpmType <- "MW"
  }
  else if (cpmType == "Kolmogorov-Smirnoff") {
    cpmType <- "KS"
  }
  else if (cpmType == "Kolmogorov-Smirnov") {
    cpmType <- "KS"
  }
  else if (cpmType == "CvM") {
    cpmType <- "CVM"
  }
  else if (cpmType == "Cramer-von-Mises") {
    cpmType <- "CVM"
  }
  else if (cpmType == "Cramer-Von-Mises") {
    cpmType <- "CVM"
