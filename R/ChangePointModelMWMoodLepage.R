...
setMethod(
  f = "updateWindowStatistic", signature = "ChangePointModelMW", definition =
    function(cpm, x) {
...
setMethod(
  f = "getTestStatistics", signature = "ChangePointModelMW", definition =
    function(cpm) {
...
setMethod(
  f = "updateWindowStatistic", signature = "ChangePointModelMood", definition =
    function(cpm, x) {
      cpm@windowStatistic$X <- c(cpm@windowStatistic$X, x)
      cpm@windowStatistic$N <- c(cpm@windowStatistic$N, cpm@n)
      return(cpm@windowStatistic)
...
setMethod(
  f = "getTestStatistics", signature = "ChangePointModelMood", definition =
    function(cpm) {
      X <- cpm@windowStatistic$X
      N <- cpm@windowStatistic$N
      n <- N[length(N)]
...
setMethod(
  f = "updateWindowStatistic", signature = "ChangePointModelLepage", definition =
    function(cpm, x) {
      return(cpm@windowStatistic)
    }
)
...
setMethod(
  f = "getTestStatistics", signature = "ChangePointModelLepage", definition =
    function(cpm) {
